namespace Photon.JobSeeker
{
    class AgencyBusiness
    {
        ...
        private const string Q_FETCH_ALL = "SELECT AgencyID, Title FROM Agency WHERE Active != 0";

        private const string Q_LOAD_BY_NAME = "SELECT AgencyID, Domain, Link FROM Agency WHERE Title = $title AND Active != 0";
