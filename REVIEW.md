...
- [بخش ۱ — بازمانده از بحرانی‌ها](#بخش-۱--بازمانده-از-بحرانیها)
...
## بخش ۱ — 🔴 بازمانده از بحرانی‌ها

### ۱.۴ گذر plaintext از HTTP هنگام fill فرم لاگین
رمزنگاری at-rest انجام شد (`SecretProtector` + مهاجرت خودکار)، اما رمز آژانس‌ها هنگام
پُر کردن فرم لاگین از سرور به اکستنشن و سپس به سایت، بدون TLS منتقل می‌شود.
**راه‌حل:** HTTPS/HSTS روی سرور.
...
3. **امنیت:** HTTPS/HSTS (گذر plaintext اعتبارنامه)، تکمیل موارد باقی‌ماندهٔ بخش ۱.
