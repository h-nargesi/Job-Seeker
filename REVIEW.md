...
>
> موارد ۱.۵ (مسیریابی پاسخ پس‌زمینه بر اساس `tab.index`) و ۱.۶ (زنجیرهٔ پیام‌رسانی بدون
> timeout/چک ok/catch) در ۱۴۰۵/۰۶/۱۸ (2026-09-09) رفع و به
> [`REVIEW-ARCHIVE.md`](REVIEW-ARCHIVE.md) منتقل شدند — تأیید نهایی با نخستین اجرای زنده.
> تنها مورد باز بخش: ۱.۷.
