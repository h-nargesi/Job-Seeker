...
12. **پروتکل پایدار تب↔trend:** ~~binding ماندگار در اکستنشن (`chrome.storage.session` + `onRemoved`)~~ (انجام شد — ۱۴۰۵/۰۶/۱۸؛ مورد ۱.۷ آرشیو شد) + lease مهلت‌دار سمت سرور (۲.۱۸) و اجرای open از SW با `chrome.tabs.create` (۲.۲۲).
