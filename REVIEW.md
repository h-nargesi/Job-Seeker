...
> موارد باز این بخش: ۲.۱۹ (اتمیزم Orders×Take)، ۲.۲۰ (قفل per-agency) و ۲.۲۱ (مرتب‌سازی
> `Tries`) — ۲.۱۹/۲.۲۰ پیگیری بعدی فاز پروتکل‌اند (پیش‌نیاز: ۲.۲۱ برای رفع اثر تورم Tries).
