...
Current tree: Chats 1–6 done (AI schema, regex gate, ranking SQL, auth/`/ai/*`,
`ai-worker` call 1 + call 2 tailoring). Remaining: Chat 7 memory API, Chat 8
`assistant-extension/`, Chat 9 Compose.
